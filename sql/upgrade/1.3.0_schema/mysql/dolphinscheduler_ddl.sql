...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_process_definition
            ADD `modify_by` varchar(36) DEFAULT '' COMMENT 'modify user';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_task_instance
            ADD `executor_id` int(11) DEFAULT NULL COMMENT 'executor id';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_task_instance
            CHANGE `app_link` `app_link` text COMMENT 'yarn app id';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_resources
            ADD `pid` int(11) DEFAULT -1 COMMENT 'parent id';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_resources
            ADD `full_name` varchar(255) DEFAULT NULL COMMENT 'full name';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_resources
            ADD `is_directory` tinyint(1) DEFAULT 0 COMMENT 'is directory';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_process_definition
            ADD `resource_ids` varchar(255) DEFAULT NULL COMMENT 'resource ids';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_process_instance
            change `worker_group_id` `worker_group` varchar(64) DEFAULT '' COMMENT 'worker group';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_process_definition
            ADD UNIQUE KEY `process_definition_unique` (`name`, `project_id`);
    END IF;
END;
