...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_datasource
            MODIFY COLUMN `note` varchar(255) DEFAULT NULL COMMENT 'description';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_schedules
            MODIFY COLUMN `crontab` varchar(255) NOT NULL COMMENT 'crontab description';
        ALTER TABLE t_ds_schedules
            MODIFY COLUMN `worker_group` varchar(64) DEFAULT '' COMMENT 'worker group id';
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_worker_group
            MODIFY COLUMN `name` varchar(255) NOT NULL COMMENT 'worker group name';
    END IF;
END;
