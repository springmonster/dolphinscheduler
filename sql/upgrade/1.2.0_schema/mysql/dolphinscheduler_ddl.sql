...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_alertgroup
            CHANGE COLUMN `desc` description varchar(255);
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_process_definition
            CHANGE COLUMN `desc` description text;
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_project
            CHANGE COLUMN `desc` description varchar(200);
    END IF;
END;
...
BEGIN
    ...
    THEN
        ALTER TABLE t_ds_resources
            CHANGE COLUMN `desc` description varchar(256);
    END IF;
END;
