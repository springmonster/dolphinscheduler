        ...
        <m-list-box-f v-if="isADMIN">
          ...
          <template slot="content">
            <x-select v-model="queueName" style="width: 100%;">
              <x-input slot="trigger" slot-scope="{ selectedModel }" readonly :placeholder="$t('Please select a queue')"
                       :value="selectedModel ? selectedModel.label : ''" @on-click-icon.stop="queueName = ''">
