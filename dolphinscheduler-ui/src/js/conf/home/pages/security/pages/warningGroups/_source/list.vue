    ...
    <div class="table-box">
      <table>
        ...
        <tr v-for="(item, $index) in list" :key="$index">
          ...
          <td>
            <x-button type="info" shape="circle" size="xsmall" data-toggle="tooltip" icon="ans-icon-user-empty"
                      :title="$t('Managing Users')" @click="_mangeUser(item)">
            </x-button>
            <x-button type="info" shape="circle" size="xsmall" data-toggle="tooltip" icon="ans-icon-edit"
                      :title="$t('Edit')" @click="_edit(item)">
            </x-button>
            <x-poptip
              ...
              <template slot="reference">
                <x-button type="error" shape="circle" size="xsmall" data-toggle="tooltip" icon="ans-icon-trash"
                          :title="$t('delete')" :disabled="item.id==1?true: false"></x-button>
              </template>
            </x-poptip>
          </td>
        </tr>
