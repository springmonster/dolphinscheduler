    ...
    <div class="table-box">
      <table class="fixed">
        ...
        <tr v-for="(item, $index) in list" :key="item.id">
          ...
          <td>
            <span class="ellipsis" data-toggle="tooltip" data-container="body" :title="_rtTooltip(item.procName)"
                  data-html="true">{{ item.procName }}</span>
          </td>
          ...
          <td><span class="ellipsis" data-toggle="tooltip" data-container="body" :title="_rtTooltip(item.sourceTab)"
                    data-html="true">{{ item.sourceTab }}</span></td>
          <td>
            <span>{{ item.sourceRowCount }}</span>
          </td>
          <td><span class="ellipsis" data-toggle="tooltip" data-container="body" :title="_rtTooltip(item.targetTab)"
                    data-html="true">{{ item.targetTab }}</span></td>
