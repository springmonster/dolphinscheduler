    ...
    <div class="table-box">
      <table class="fixed">
        ...
        <tr v-for="(item, $index) in list" :key="item.id">
          ...
          <td style="min-width: 200px;max-width: 300px;padding-right: 10px;"><a href="javascript:" class="links"
                                                                                @click="_go(item)"><span
            class="ellipsis" :title="item.processInstanceName">{{ item.processInstanceName }}</span></a></td>
          <td>
