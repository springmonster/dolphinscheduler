...
<template>
  <div class="spark-model">
    ...
    <m-list-box>
      ...
      <div slot="content">
        <treeselect v-model="mainJar" :options="mainJarLists" :disable-branch-nodes="true" :normalizer="normalizer"
                    :disabled="isDetails" :placeholder="$t('Please enter main package')">
    ...
    dataProcess (backResource) {
      ...
      if (this.resourceList.length > 0) {
        ...
        if (optionsCmp.length > 0) {
          ...
          this.mainJarList = _.filter(this.mainJarList, o => {
            return o.id !== -1
          })
