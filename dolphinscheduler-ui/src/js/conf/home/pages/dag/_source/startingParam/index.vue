...
<template>
  <div class="starting-params-dag-index">
    <template v-if="isView && isActive">
      <div class="box">
        <p class="box-hd"><em class="fa ans-icon-arrow-circle-right"></em><strong>{{ $t('Startup parameter') }}</strong>
        </p>
        <ul class="box-bd">
          ...
          <li><span class="tab">{{ $t('Cc') }}：</span><span class="content">{{ startupParam.receiversCc || '-' }}</span>
          </li>
        </ul>
      </div>
    </template>
