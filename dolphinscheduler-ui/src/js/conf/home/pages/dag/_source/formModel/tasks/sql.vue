...
<template>
  <div class="sql-model">
    ...
    <m-list-box v-show="sqlType === '0'">
      ...
      <div slot="content">
        <x-input type="input" :disabled="isDetails" size="medium" v-model="limit"
    ...
    <template v-if="sqlType==0 && sendEmail">
      ...
      <m-list-box>
        ...
        <div slot="content">
          <m-email ref="refEmail" v-model="receivers" :disabled="isDetails" :repeat-data="receiversCc"
                   style="min-width: 300px;"></m-email>
        </div>
      </m-list-box>
      <m-list-box>
