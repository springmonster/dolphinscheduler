      ...
      <x-radio-group v-model="radioHour" vertical>
        ...
        <div class="list-box">
          <x-radio label="intervalHour">
            ...
            <m-input-number :min="0" :max="23" :props-value="parseInt(intervalPerformVal)"
                            @on-number="onIntervalPerform"></m-input-number>
            <span class="text">{{ $t('小时执行 从') }}</span>
            <m-input-number :min="0" :max="23" :props-value="parseInt(intervalStartVal)"
        ...
        <div class="list-box">
          <x-radio label="cycleHour">
            ...
            <m-input-number :min="0" :max="23" :props-value="parseInt(cycleStartVal)"
                            @on-number="onCycleStart"></m-input-number>
            <span class="text">{{ $t('到') }}</span>
            <m-input-number :min="0" :max="23" :props-value="parseInt(cycleEndVal)"
