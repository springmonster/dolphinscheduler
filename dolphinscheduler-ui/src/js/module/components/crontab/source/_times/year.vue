      ...
      <x-radio-group v-model="radioYear" vertical>
        ...
        <div class="list-box">
          <x-radio label="intervalYear">
            ...
            <m-input-number :min="2019" :max="2030" :props-value="parseInt(intervalPerformVal)"
                            @on-number="onIntervalPerform"></m-input-number>
            <span class="text">{{ $t('年执行 从') }}</span>
            <m-input-number :min="2019" :max="2030" :props-value="parseInt(intervalStartVal)"
        ...
        <div class="list-box">
          <x-radio label="cycleYear">
            ...
            <m-input-number :min="2019" :max="2030" :props-value="parseInt(cycleStartVal)"
                            @on-number="onCycleStart"></m-input-number>
            <span class="text">{{ $t('到') }}</span>
            <m-input-number :min="2019" :max="2030" :props-value="parseInt(cycleEndVal)"
