      ...
      <x-radio-group v-model="radioMinute" vertical>
        ...
        <div class="list-box">
          <x-radio label="intervalMinute">
            ...
            <m-input-number :min="0" :max="59" :props-value="parseInt(intervalPerformVal)"
                            @on-number="onIntervalPerform"></m-input-number>
            <span class="text">{{ $t('分执行 从') }}</span>
            <m-input-number :min="0" :max="59" :props-value="parseInt(intervalStartVal)"
                            @on-number="onIntervalStart"></m-input-number>
        ...
        <div class="list-box">
          <x-radio label="specificMinute">
            ...
            <x-select multiple :placeholder="$t('请选择具体分钟数')" v-model="specificMinutesVal"
                      @on-change="onspecificMinutes">
              <x-option
        ...
        <div class="list-box">
          <x-radio label="cycleMinute">
            ...
            <m-input-number :min="0" :max="59" :props-value="parseInt(cycleStartVal)"
                            @on-number="onCycleStart"></m-input-number>
            <span class="text">{{ $t('到') }}</span>
            <m-input-number :min="0" :max="59" :props-value="parseInt(cycleEndVal)"
                            @on-number="onCycleEnd"></m-input-number>
