      ...
      <x-radio-group v-model="radioDay" vertical>
        ...
        <div class="list-box">
          <x-radio label="WkintervalWeek">
            ...
            <m-input-number :min="0" :max="7" :props-value="parseInt(WkintervalWeekPerformVal)"
                            @on-number="onWkintervalWeekPerform"></m-input-number>
        ...
        <div class="list-box">
          <x-radio label="intervalDay">
            <span class="text">{{ $t('每隔') }}</span>
            <m-input-number :min="0" :max="31" :props-value="parseInt(intervalDayPerformVal)"
                            @on-number="onIntervalDayPerform"></m-input-number>
            <span class="text">{{ $t('天执行 从') }}</span>
            <m-input-number :min="1" :max="31" :props-value="parseInt(intervalDayStartVal)"
                            @on-number="onIntervalDayStart"></m-input-number>
        ...
        <div class="list-box">
          <x-radio label="monthTailBefore">
            <m-input-number :min="0" :max="31" :props-value="parseInt(monthTailBeforeVal)"
                            @on-number="onMonthTailBefore"></m-input-number>
        ...
        <div class="list-box">
          <x-radio label="recentlyWorkingDaysMonth">
            ...
            <m-input-number :min="0" :max="31" :props-value="parseInt(recentlyWorkingDaysMonthVal)"
                            @on-number="onRecentlyWorkingDaysMonth"></m-input-number>
        ...
        <div class="list-box">
          <x-radio label="WkmonthNumWeeks">
            ...
            <m-input-number :min="0" :max="31" :props-value="parseInt(WkmonthNumWeeksDayVal)"
                            @on-number="onWkmonthNumWeeksDay"></m-input-number>
